...
class DepartamentResource extends Resource
{
    ...
    protected static ?string $navigationIcon = 'heroicon-o-building-office'; /* C07: Cambiar icono del recurso */
    protected static ?int $navigationSort = 7; // C09: Cambiar orden de navegación
