    <form action="controller/registroAgregar.php" method="post">
        ...
        <div class="bloque-izquierda">
            ...
            <input type="number" name="codigo" id="codigo" required maxlength="4" minlength="4" placeholder="Código de registro" class="placeholder-color">
            ...
            <!-- TIPO DE VEHÍCULO -->
            <label for="tipo_veh">Tipo de Vehículo:</label>
            <select name="tipo_veh" id="tipo_veh" required>
        ...
        <div class="bloque-derecha">
            ...
            <input type="number" name="ano" id="ano" maxlength="4" minlength="4" placeholder="Año del Vehículo" class="placeholder-color">
            ...
            <input type="number" name="precio" id="precio" maxlength="9" minlength="7" placeholder="1.000.000" class="placeholder-color">
