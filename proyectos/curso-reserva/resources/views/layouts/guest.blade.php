<!doctype html> {{-- C09 Plantilla Guest --}}
...
<head>
    ...
    <title>Sign In | Reservas Acceso</title>
...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> dgroes. Sistema de Reservas <i class="mdi mdi-heart text-danger"></i>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    @stack('scripts') {{-- C08 Inclusión de scripts @stack --}}
</body>
