            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascsript: void(0);">Reserva</a></li>
                        <li class="breadcrumb-item active">Modificar Reserva</li>
                    </ol>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row gy-4" method="POST" action="{{ route('reservations.update', $reservation->id) }}">
                        @csrf
                        @method('PUT')
                                ...
                                <select class="form-select @error('consultant_id') is-invalid @enderror" id="consultant_id"
                                    ...
                                    @foreach ($consultants as $consultant)
                                        <option value="{{ $consultant->id }}"
                                            {{ $consultant->id == $reservation->consultant_id ? 'selected' : '' }}>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <input type="date" class="form-control @error('reservation_date') is-invalid @enderror"
                                    id="reservation_date" name="reservation_date" value="{{ old('reservation_date', $reservation->reservation_date) }}"
                                    required>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <select class="form-select @error('start_time') is-invalid @enderror" id="start_time"
                                    ...
                                    <option value="09:00" {{ $reservation->start_time == '09:00:00' ? 'selected' : '' }}>09:00</option>
                                    <option value="10:00" {{ $reservation->start_time == '10:00:00' ? 'selected' : '' }}>10:00</option>
                                    <option value="11:00" {{ $reservation->start_time == '11:00:00' ? 'selected' : '' }}>11:00</option>
                                    <option value="12:00" {{ $reservation->start_time == '12:00:00' ? 'selected' : '' }}>12:00</option>
                                    <option value="13:00" {{ $reservation->start_time == '13:00:00' ? 'selected' : '' }}>13:00</option>
                                    <option value="14:00" {{ $reservation->start_time == '14:00:00' ? 'selected' : '' }}>14:00</option>
                                    <option value="15:00" {{ $reservation->start_time == '15:00:00' ? 'selected' : '' }}>15:00</option>
                                    <option value="16:00" {{ $reservation->start_time == '16:00:00' ? 'selected' : '' }}>16:00</option>
                                </select>
                                @error('start_time')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <input type="text" class="form-control @error('end_time') is-invalid @enderror"
                                    id="end_time" name="end_time" value="{{ old('end_time', $reservation->end_time) }}" required readonly>
                                @error('end_time')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <input type="text" class="form-control @error('total_amount') is-invalid @enderror"
                                    id="total_amount" name="total_amount" value="{{old('total_amount', $reservation->total_amount)}}" required readonly>
                                @error('total_amount')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
