    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row gy-4" method="POST" action="{{ route('usuarios.update', $usuario->id) }}"
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <input type="tel" class="form-control @error('teléfono') is-invalid @enderror"
                                    id="teléfono" name="teléfono" value="{{ old('teléfono', $usuario->teléfono) }}" required>
                                @error('teléfono')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div>
                                ...
                                <select class="form-select @error('rol_id') is-invalid @enderror" id="rol_id" name="rol_id"
                                    ...
                                    @foreach ($roles as $role)
                                        <option value="{{ $role->id }}" {{$usuario->rol_id == $role->id ? 'selected' : ''}} >{{ $role->name }}</option>
                                    @endforeach
                                </select>
                                @error('rol_id')
                                    <span class="invalid-feedback" role="alert">
