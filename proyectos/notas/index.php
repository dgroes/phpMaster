...
require_once 'condif/db.php';
require_once 'condif/parameters.php';
...
if (class_exists($name_controller)) {
    ...
    //Verifica si existe el parámetro 'action' en URL y el método correspondiete en el controlador
    if (isset($_GET['action']) && method_exists($controller, $_GET['action'])) {
        $action = $_GET['action']; //$action será el nombre del método de las clases, por ejemplo si la clase tiene le metodo getAll, dentro de $action estará guardado 'getAll'
